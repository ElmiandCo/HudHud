...
function commandCenter(){
 const defs=[["github","🐙","GitHub","Repositories, files, issues and pull requests","Connected"],["vercel","▲","Vercel","Projects, deployments and production","Connected"],["supabase","⚡","Supabase","Database, authentication and resources","Connected"],["stripe","💳","Stripe","Subscriptions, one-time sales and checkout","Connected"],["hudhud","🦉","HudHud","Command layer, workspace and tools","Online"],["brain","🧠","HudHud Brain","Reasoning and local AI bridge","Online"],["openclaw","🦞","OpenClaw","Local computer-side actions","Local"]];
 const placeholders=[["☁️","AWS","Cloud infrastructure"],["☁️","Azure","Cloud infrastructure"],["☁️","Google Cloud","Cloud infrastructure"],["✉️","Gmail","Email and communication"],["📅","Google Calendar","Scheduling and events"],["💬","Slack","Team communication"],["📋","Notion","Knowledge and docs"],["🟣","Linear","Project management"],["🟠","Jira","Engineering workflows"],["💼","Microsoft 365","Business productivity"],["🤖","OpenAI","AI provider"],["🤖","Anthropic","AI provider"],["✨","Google Gemini","AI provider"],["🤖","Groq","AI provider"],["🤖","xAI","AI provider"]];
 return '<div class="command-center"><div class="command-hero"><div><span class="eyebrow">HUDHUD COMMAND CENTER</span><h2>Ecosystem Control & Analytics</h2><p>Monitor infrastructure, connected services, business activity and the operating history of HudHud.</p></div><div class="command-hero-actions"><button class="primary" data-command-diagnostic>🔎 Run Full Diagnostic</button><button class="secondary" data-command-add-tool>＋ Add Tool</button></div></div>'+
 '<section class="analytics-kpis"><div class="analytics-kpi"><span>💳 Subscription MRR</span><strong>$39.96</strong><small>4 active demo subscribers</small></div><div class="analytics-kpi"><span>🧾 One-Time Revenue</span><strong>$299.70</strong><small>5 demo customers</small></div><div class="analytics-kpi"><span>📈 Total Demo Revenue</span><strong>$339.66</strong><small>Historical test dataset</small></div><div class="analytics-kpi"><span>🔴 Canceled</span><strong>1</strong><small>X-Subscriber-06</small></div></section>'+
 '<section class="card analytics-panel"><div class="command-section-head"><div><span class="eyebrow">POWER BI STYLE ANALYTICS</span><h3>Business & system performance</h3><p>Toggle series and compare operating metrics.</p></div><div class="analytics-controls"><select id="analyticsRange"><option value="all">All demo history</option><option value="90">Last 90 days</option><option value="180">Last 180 days</option></select></div></div><div class="analytics-filter-row">'+["subscription","onetime","projects","steps","opportunities","ai"].map(k=>'<label><input type="checkbox" data-analytics-series="'+k+'" checked> '+({subscription:"Subscriptions",onetime:"One-time sales",projects:"Projects completed",steps:"Steps completed",opportunities:"Opportunities",ai:"AI usage"}[k])+'</label>').join('')+'</div><div id="analyticsChart" class="analytics-chart"></div><div class="analytics-legend"><span>Hover a point for the period value</span><span>Demo data • not live Stripe charges</span></div></section>'+
 '<section class="command-grid"><div class="card analytics-sales"><div class="command-section-head"><div><span class="eyebrow">STRIPE SALES</span><h3>Subscriptions & one-time customers</h3></div></div><div class="sales-breakdown"><div><strong>5</strong><span>Active subscriptions</span></div><div><strong>1</strong><span>Canceled subscription</span></div><div><strong>5</strong><span>One-time customers</span></div><div><strong>$339.66</strong><span>Demo revenue</span></div></div><div id="analyticsCustomers" class="analytics-customers"></div></div><div class="card analytics-infra"><div class="command-section-head"><div><span class="eyebrow">INFRASTRUCTURE</span><h3>Connected services</h3></div></div><div id="commandHealthList">'+defs.map(x=>'<div class="command-service" data-command-service="'+x[0]+'"><span class="command-service-icon">'+x[1]+'</span><div><strong>'+x[2]+'</strong><small>'+x[3]+'</small></div><span class="command-status status-unknown">CHECKING</span></div>').join('')+'</div></div></section>'+
 '<section class="command-grid"><div class="card command-diagnostic-card"><div class="command-section-head"><div><span class="eyebrow">TAILSCALE / OPENCLAW</span><h3>Infrastructure awareness</h3></div></div><div class="analytics-infra-grid"><div><strong>7</strong><span>Known devices</span></div><div><strong>🟢</strong><span>HudHud Brain</span></div><div><strong>🟢</strong><span>OpenClaw Gateway</span></div><div><strong>🟢</strong><span>Tailscale</span></div></div><div id="commandDiagnosticLog" class="command-diagnostic-log"><div class="command-log-empty">Run a full diagnostic to inspect live connections.</div></div></div><div class="card command-resources"><div class="command-section-head"><div><span class="eyebrow">RESOURCE MAP</span><h3>Connected resources</h3></div></div><div id="commandResourceGrid" class="command-resource-grid"></div></div></section>'+
 '<section class="card command-add-tool"><div class="command-section-head"><div><span class="eyebrow">EXTEND HUDHUD</span><h3>＋ Add a tool</h3><p>Connect additional services when you are ready.</p></div></div><div class="command-tool-grid">'+placeholders.map(x=>'<div class="command-tool-placeholder"><span>'+x[0]+'</span><div><strong>'+x[1]+'</strong><small>'+x[2]+'</small></div><em>Coming soon</em></div>').join('')+'</div></section><div id="commandToolModal"></div></div>';
}
const analyticsDemo=[{date:"2026-01-12",subscription:1,onetime:0,projects:0,steps:3,opportunities:2,ai:12},{date:"2026-02-03",subscription:1,onetime:59.94,projects:1,steps:7,opportunities:3,ai:18},{date:"2026-03-08",subscription:1,onetime:0,projects:1,steps:9,opportunities:4,ai:24},{date:"2026-04-02",subscription:1,onetime:119.88,projects:2,steps:12,opportunities:5,ai:31},{date:"2026-05-21",subscription:1,onetime:0,projects:1,steps:14,opportunities:6,ai:38},{date:"2026-06-29",subscription:1,onetime:59.94,projects:2,steps:18,opportunities:7,ai:44},{date:"2026-07-14",subscription:1,onetime:0,projects:2,steps:21,opportunities:8,ai:51},{date:"2026-08-11",subscription:0,onetime:119.88,projects:3,steps:26,opportunities:9,ai:63},{date:"2026-08-18",subscription:-1,onetime:0,projects:1,steps:29,opportunities:7,ai:58},{date:"2026-09-05",subscription:1,onetime:0,projects:2,steps:34,opportunities:10,ai:72},{date:"2026-09-19",subscription:0,onetime:59.94,projects:3,steps:41,opportunities:12,ai:86}];
const analyticsCustomers=[["X-Subscriber-01","Pro","Jan 12, 2026","Active"],["X-Subscriber-02","Pro","Mar 8, 2026","Active"],["X-Subscriber-03","Premium","May 21, 2026","Active"],["X-Subscriber-04","Pro","Jul 14, 2026","Active"],["X-Subscriber-05","Premium","Sep 5, 2026","Active"],["X-Subscriber-06","Pro","Apr 2 → Aug 18, 2026","Canceled"],["X-Customer-01","Pro Lifetime","Feb 3, 2026","One-time"],["X-Customer-02","Premium Lifetime","Apr 17, 2026","One-time"],["X-Customer-03","Pro Lifetime","Jun 29, 2026","One-time"],["X-Customer-04","Premium Lifetime","Aug 11, 2026","One-time"],["X-Customer-05","Pro Lifetime","Sep 19, 2026","One-time"]];
function renderAnalytics(){const host=document.getElementById("analyticsChart"),customers=document.getElementById("analyticsCustomers");if(!host)return;const keys=["subscription","onetime","projects","steps","opportunities","ai"],selected=keys.filter(k=>document.querySelector('[data-analytics-series="'+k+'"]')?.checked),width=900,height=260,pad=35,max=Math.max(1,...selected.flatMap(k=>analyticsDemo.map(d=>Math.abs(d[k]))));const lines=selected.map((k,idx)=>{const pts=analyticsDemo.map((d,i)=>{const xx=pad+i*(width-pad*2)/(analyticsDemo.length-1),yy=height-pad-(d[k]/max)*(height-pad*2);return xx.toFixed(1)+","+yy.toFixed(1)}).join(" ");return '<polyline class="analytics-line line-'+idx+'" points="'+pts+'"></polyline>'}).join("");const dots=selected.map((k,idx)=>analyticsDemo.map((d,i)=>{const xx=pad+i*(width-pad*2)/(analyticsDemo.length-1),yy=height-pad-(d[k]/max)*(height-pad*2);return '<circle class="analytics-dot line-'+idx+'" cx="'+xx+'" cy="'+yy+'" r="3"><title>'+d.date+' • '+k+": "+d[k]+'</title></circle>'}).join("")).join("");host.innerHTML='<svg viewBox="0 0 '+width+' '+height+'" preserveAspectRatio="none"><line class="analytics-axis" x1="'+pad+'" y1="'+(height-pad)+'" x2="'+(width-pad)+'" y2="'+(height-pad)+'"></line>'+lines+dots+'</svg><div class="analytics-xlabels">'+analyticsDemo.map(d=>'<span>'+d.date.slice(5)+'</span>').join("")+'</div>';if(customers)customers.innerHTML=analyticsCustomers.map(c=>'<div class="analytics-customer-row"><strong>'+c[0]+'</strong><span>'+c[1]+'</span><small>'+c[2]+'</small><em class="'+(c[3]==="Canceled"?"canceled":"")+'">'+c[3]+'</em></div>').join("")}
